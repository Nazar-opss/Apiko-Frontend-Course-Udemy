class API {
    ...
    async fetchMoviesRecommendations(movie_id){
        const options = {
            method: 'GET',
            headers: {
              accept: 'application/json',
        ...
        let recommendations =await fetch(`https://api.themoviedb.org/3/movie/${movie_id}/recommendations?language=en-US&page=1`, options)
